...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "어웨이큰은 기독교 신앙에 기반한 원칙들을 토대로 설계된 프로그램입니다. 성경 말씀이 인용되고, 간단한 기도 등이 포함되어 있습니다. 다만, 전도나 신앙 강요를 하지 않으며, 종교적 배경과 관계없이 누구나 참여할 수 있습니다. 프로그램의 핵심은 자기 인식, 관계 변화, 비전 정렬이며, 신앙적 요소는 그 과정을 지지하는 프레임워크로 활용됩니다.",
  },
  {
