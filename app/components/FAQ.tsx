...
const faqs = [
  {
    question: "Reveal에서는 실제로 무엇을 하나요?",
    answer:
      "Reveal은 강의를 듣고 지식을 배우는 세미나라기보다, 내 삶에서 반복되는 감정·관계·선택의 패턴을 발견하는 체험형 과정입니다. 소그룹 대화, 개인 성찰, 1:1 코칭을 통해 그 패턴 아래의 믿음과 태도를 살펴보고, 내가 원하는 삶의 방향과 다음 행동을 다시 정렬합니다.",
  },
  {
  ...
  {
    question: "등록가는 어떻게 달라지나요?",
    answer:
      "Reveal 등록가는 얼리버드 95만원(5/31까지), 할인가 125만원(6/30까지), 일반가 145만원(8/5까지) 순서로 적용됩니다. 현재 PayApp 결제 링크에는 6월 30일까지 적용되는 할인가 125만원이 반영되어 있습니다.",
  },
  {
