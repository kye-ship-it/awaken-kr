...
const faqs = [
  ...
  {
    question: "Reveal과 Awaken의 차이점은 무엇인가요?",
    answer:
      "Reveal은 3일간 삶의 패턴을 탐색하고 자기 인식에 초점을 맞추는 프로그램입니다. Awaken은 4일간 더 깊이 몰입하여 보이지 않던 한계를 넘어서는 경험입니다. 두 프로그램은 독립적으로 참여할 수 있으며, 순서에 관계없이 각각 완전한 경험을 제공합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "자기 자신의 패턴을 탐색하고 비전을 발견하는 데 관심이 있다면 Reveal을, 더 깊은 몰입과 실질적인 삶의 전환을 원하신다면 Awaken을 추천드립니다. 확신이 서지 않으시면 관심 등록 후 상담을 통해 안내받으실 수 있습니다.",
  },
];
